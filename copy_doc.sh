...
# This script converts the shared Polaris documentation into the Markdown format
...
echo "========================="
echo "Running this script will update Polaris' documentation. Before running, confirm that "
...
DOC_SHARED="Polaris Model Documentation.docx"  # the file name of the shared version
