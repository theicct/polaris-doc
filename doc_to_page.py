"""
Convert the Polaris documentation from raw Word conversion to Jekyll page format.
...
def add_front_matter(lines, version):
    ...
    lines.insert(2, f"title: 'Polaris {version} Documentation'\n")
...
def add_download_button(doc, version):
    ...
    btn = (
        f"<button name='download' onclick=\"location.href='../Polaris {version} Model "
